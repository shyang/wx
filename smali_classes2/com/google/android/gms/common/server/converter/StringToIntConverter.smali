...
# instance fields
.field final apn:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private final apo:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap",
            "<",
...
.field private final apq:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->apn:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->apo:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->apq:Ljava/util/ArrayList;
...
.method private b(Ljava/util/ArrayList;)V
    ...
    iget-object v2, v0, Lcom/google/android/gms/common/server/converter/StringToIntConverter$Entry;->apr:Ljava/lang/String;

    iget v0, v0, Lcom/google/android/gms/common/server/converter/StringToIntConverter$Entry;->aps:I

    iget-object v3, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->apn:Ljava/util/HashMap;
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->apo:Ljava/util/HashMap;
...
.method public final synthetic convertBack(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->apo:Ljava/util/HashMap;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->apn:Ljava/util/HashMap;
