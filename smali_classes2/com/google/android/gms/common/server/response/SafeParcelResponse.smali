...
# instance fields
.field final apB:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

.field private final apJ:Landroid/os/Parcel;
...
.method constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;)V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apJ:Landroid/os/Parcel;

    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apK:I

    iput-object p3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apB:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apB:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
    ...
    :goto_0
    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apL:I
    ...
    iget-object v0, v0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->apF:Ljava/lang/String;
...
.method private static a(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    invoke-static {v1}, Lcom/google/android/gms/c/x;->ag(Ljava/lang/String;)Ljava/lang/String;
...
.method private a(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->ki()Z
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kh()I
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kn()Ljava/util/Map;
    ...
    invoke-static {v0}, Lcom/google/android/gms/c/x;->ag(Ljava/lang/String;)Ljava/lang/String;
...
.method private a(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    iget-object v1, v0, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->apC:Lcom/google/android/gms/common/server/response/FastJsonResponse$a;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kh()I
...
.method private b(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->kg()Z
...
.method protected final kd()Ljava/lang/Object;
    .locals 2
...
.method public final kq()Landroid/os/Parcel;
    .locals 2

    iget v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apL:I

    packed-switch v0, :pswitch_data_0

    :goto_0
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apJ:Landroid/os/Parcel;
    ...
    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apM:I

    :pswitch_1
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apJ:Landroid/os/Parcel;

    iget v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apM:I

    invoke-static {v0, v1}, Lcom/google/android/gms/common/internal/safeparcel/b;->u(Landroid/os/Parcel;I)V

    const/4 v0, 0x2

    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apL:I
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->kq()Landroid/os/Parcel;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->apB:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->qz:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->X(Ljava/lang/String;)Ljava/util/Map;
