...
# instance fields
.field private final tH:Landroid/support/v4/e/a;
...
.field private final tI:Landroid/support/v4/media/MediaBrowserServiceCompat$f;

.field tJ:Landroid/support/v4/media/session/MediaSessionCompat$Token;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->tH:Landroid/support/v4/e/a;
    ...
    iput-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->tI:Landroid/support/v4/media/MediaBrowserServiceCompat$f;
...
.method static synthetic a(Landroid/support/v4/media/MediaBrowserServiceCompat;)Landroid/support/v4/media/MediaBrowserServiceCompat$f;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->tI:Landroid/support/v4/media/MediaBrowserServiceCompat$f;
...
.method static synthetic a(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$b;Landroid/os/Bundle;)V
    ...
    .prologue
    .line 73
    iget-object v0, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->tU:Ljava/util/HashMap;
    ...
    iput v1, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tF:I
    ...
    iget-object v2, p2, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->tQ:Ljava/lang/String;
...
.method static synthetic a(Landroid/support/v4/media/MediaBrowserServiceCompat;Ljava/lang/String;Landroid/support/v4/os/ResultReceiver;)V
    ...
    iget-boolean v1, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tX:Z
    ...
    iget-object v0, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tV:Ljava/lang/Object;
    ...
    iput-boolean v1, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tX:Z

    const/4 v1, 0x0

    iget v2, v0, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->tF:I

    invoke-virtual {v0, v1, v2}, Landroid/support/v4/media/MediaBrowserServiceCompat$c;->b(Ljava/lang/Object;I)V
...
.method static synthetic a(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$b;Landroid/os/Bundle;)Z
    ...
    iget-object v0, p1, Landroid/support/v4/media/MediaBrowserServiceCompat$b;->tU:Ljava/util/HashMap;
...
.method static synthetic b(Landroid/support/v4/media/MediaBrowserServiceCompat;)Landroid/support/v4/e/a;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v4/media/MediaBrowserServiceCompat;->tH:Landroid/support/v4/e/a;
...
# virtual methods
.method public abstract bx()Landroid/support/v4/media/MediaBrowserServiceCompat$a;
.end method
