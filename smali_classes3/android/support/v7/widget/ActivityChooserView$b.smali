...
.method private constructor <init>(Landroid/support/v7/widget/ActivityChooserView;)V
    ...
    .prologue
    .line 552
    iput-object p1, p0, Landroid/support/v7/widget/ActivityChooserView$b;->ST:Landroid/support/v7/widget/ActivityChooserView;
...
.method public final onClick(Landroid/view/View;)V
    ...
    .prologue
    .line 588
    iget-object v0, p0, Landroid/support/v7/widget/ActivityChooserView$b;->ST:Landroid/support/v7/widget/ActivityChooserView;
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ActivityChooserView;->er()Z
    ...
    .line 591
    iget-object v1, p0, Landroid/support/v7/widget/ActivityChooserView$b;->ST:Landroid/support/v7/widget/ActivityChooserView;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v7/widget/d;->aC(I)Landroid/content/Intent;
...
.method public final onDismiss()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/ActivityChooserView;->SL:Landroid/support/v4/view/d;
...
.method public final onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    iget-object v2, v0, Landroid/support/v7/widget/ActivityChooserView$a;->SU:Landroid/support/v7/widget/d;

    iget-object v3, v2, Landroid/support/v7/widget/d;->Sp:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    invoke-virtual {v2}, Landroid/support/v7/widget/d;->el()V

    iget-object v0, v2, Landroid/support/v7/widget/d;->Sq:Ljava/util/List;
    ...
    iget-object v1, v2, Landroid/support/v7/widget/d;->Sq:Ljava/util/List;
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/ActivityChooserView$a;->SW:Z
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/widget/d;->aC(I)Landroid/content/Intent;
