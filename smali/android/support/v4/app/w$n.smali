.class final Landroid/support/v4/app/w$n;
...
.method public final b(Landroid/support/v4/app/w$d;)Landroid/app/Notification;
    ...
    .prologue
    .line 569
    iget-object v0, p1, Landroid/support/v4/app/w$d;->mContext:Landroid/content/Context;

    iget-object v1, p1, Landroid/support/v4/app/w$d;->rX:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroid/support/v4/app/w$d;->rF:Ljava/lang/CharSequence;

    iget-object v5, p1, Landroid/support/v4/app/w$d;->rD:Landroid/widget/RemoteViews;

    iget v6, p1, Landroid/support/v4/app/w$d;->rG:I

    iget-object v7, p1, Landroid/support/v4/app/w$d;->rB:Landroid/app/PendingIntent;

    iget-object v8, p1, Landroid/support/v4/app/w$d;->rC:Landroid/app/PendingIntent;

    iget-object v9, p1, Landroid/support/v4/app/w$d;->rE:Landroid/graphics/Bitmap;
