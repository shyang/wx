...
.field private so:Landroid/app/Notification$Builder;
...
.method public constructor <init>(Landroid/content/Context;Landroid/app/Notification;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Landroid/widget/RemoteViews;ILandroid/app/PendingIntent;Landroid/app/PendingIntent;Landroid/graphics/Bitmap;IIZZZILjava/lang/CharSequence;ZLjava/util/ArrayList;Landroid/os/Bundle;Ljava/lang/String;ZLjava/lang/String;)V
    ...
    iput-object v4, p0, Landroid/support/v4/app/ac$a;->st:Ljava/util/List;
    ...
    iput-object v4, p0, Landroid/support/v4/app/ac$a;->so:Landroid/app/Notification$Builder;
    ...
    iput-object v4, p0, Landroid/support/v4/app/ac$a;->mExtras:Landroid/os/Bundle;

    .line 72
    if-eqz p20, :cond_0

    .line 73
    iget-object v4, p0, Landroid/support/v4/app/ac$a;->mExtras:Landroid/os/Bundle;
    ...
    .line 76
    iget-object v5, p0, Landroid/support/v4/app/ac$a;->mExtras:Landroid/os/Bundle;
...
# virtual methods
.method public final a(Landroid/support/v4/app/z$a;)V
    .locals 2

    .prologue
    .line 97
    iget-object v0, p0, Landroid/support/v4/app/ac$a;->st:Ljava/util/List;

    iget-object v1, p0, Landroid/support/v4/app/ac$a;->so:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, Landroid/support/v4/app/ab;->b(Landroid/app/Notification$Builder;Landroid/support/v4/app/z$a;)Landroid/os/Bundle;
...
.method public final bk()Landroid/app/Notification$Builder;
    .locals 1

    .prologue
    .line 102
    iget-object v0, p0, Landroid/support/v4/app/ac$a;->so:Landroid/app/Notification$Builder;
...
.method public final build()Landroid/app/Notification;
    ...
    invoke-static {v0}, Landroid/support/v4/app/ab;->e(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    .line 111
    iget-object v1, p0, Landroid/support/v4/app/ac$a;->mExtras:Landroid/os/Bundle;
