...
# instance fields
.field final synthetic Aa:Landroid/support/v4/widget/a;
...
.method private constructor <init>(Landroid/support/v4/widget/a;)V
    ...
    .prologue
    .line 684
    iput-object p1, p0, Landroid/support/v4/widget/a$b;->Aa:Landroid/support/v4/widget/a;
...
.method public final run()V
    ...
    .line 687
    iget-object v1, p0, Landroid/support/v4/widget/a$b;->Aa:Landroid/support/v4/widget/a;
    ...
    iput-wide v2, v1, Landroid/support/v4/widget/a$a;->zX:J

    iget-wide v2, v1, Landroid/support/v4/widget/a$a;->mStartTime:J

    iput-wide v2, v1, Landroid/support/v4/widget/a$a;->zU:J

    const/high16 v2, 0x3f000000    # 0.5f

    iput v2, v1, Landroid/support/v4/widget/a$a;->zY:F

    iput v0, v1, Landroid/support/v4/widget/a$a;->zV:I

    iput v0, v1, Landroid/support/v4/widget/a$a;->zW:I
    ...
    .line 697
    iget-wide v2, v1, Landroid/support/v4/widget/a$a;->zX:J
    ...
    iget-wide v4, v1, Landroid/support/v4/widget/a$a;->zX:J

    iget v6, v1, Landroid/support/v4/widget/a$a;->zZ:I
    ...
    iget-object v0, p0, Landroid/support/v4/widget/a$b;->Aa:Landroid/support/v4/widget/a;
    ...
    .line 707
    :cond_5
    iget-wide v2, v1, Landroid/support/v4/widget/a$a;->zU:J
    ...
    iget-wide v4, v1, Landroid/support/v4/widget/a$a;->zU:J
    ...
    iget v3, v1, Landroid/support/v4/widget/a$a;->zS:F

    mul-float/2addr v2, v3

    float-to-int v2, v2

    iput v2, v1, Landroid/support/v4/widget/a$a;->zV:I

    long-to-float v2, v4

    mul-float/2addr v0, v2

    iget v2, v1, Landroid/support/v4/widget/a$a;->zT:F
    ...
    .line 709
    iget v0, v1, Landroid/support/v4/widget/a$a;->zW:I

    .line 711
    iget-object v1, p0, Landroid/support/v4/widget/a$b;->Aa:Landroid/support/v4/widget/a;

    invoke-virtual {v1, v0}, Landroid/support/v4/widget/a;->ae(I)V
