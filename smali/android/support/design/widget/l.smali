...
.field ih:Landroid/support/design/widget/d;
...
.field final im:Landroid/support/design/widget/VisibilityAwareImageButton;

.field final in:Landroid/support/design/widget/p;

.field io:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/l;->il:[I
...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/p;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/l;->gy:Landroid/graphics/Rect;

    .line 61
    iput-object p1, p0, Landroid/support/design/widget/l;->im:Landroid/support/design/widget/VisibilityAwareImageButton;

    .line 62
    iput-object p2, p0, Landroid/support/design/widget/l;->in:Landroid/support/design/widget/p;
...
.method final a(ILandroid/content/res/ColorStateList;)Landroid/support/design/widget/d;
    ...
    .prologue
    .line 138
    iget-object v0, p0, Landroid/support/design/widget/l;->im:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 140
    sget v2, Landroid/support/design/a$c;->Y:I

    invoke-virtual {v0, v2}, Landroid/content/res/Resources;->getColor(I)I

    move-result v2

    sget v3, Landroid/support/design/a$c;->X:I

    invoke-virtual {v0, v3}, Landroid/content/res/Resources;->getColor(I)I

    move-result v3

    sget v4, Landroid/support/design/a$c;->V:I

    invoke-virtual {v0, v4}, Landroid/content/res/Resources;->getColor(I)I

    move-result v4

    sget v5, Landroid/support/design/a$c;->W:I

    invoke-virtual {v0, v5}, Landroid/content/res/Resources;->getColor(I)I

    move-result v0

    iput v2, v1, Landroid/support/design/widget/d;->fq:I

    iput v3, v1, Landroid/support/design/widget/d;->fr:I

    iput v4, v1, Landroid/support/design/widget/d;->fs:I

    iput v0, v1, Landroid/support/design/widget/d;->ft:I

    .line 145
    int-to-float v0, p1

    iget v2, v1, Landroid/support/design/widget/d;->fp:F

    cmpl-float v2, v2, v0

    if-eqz v2, :cond_0

    iput v0, v1, Landroid/support/design/widget/d;->fp:F

    iget-object v2, v1, Landroid/support/design/widget/d;->fl:Landroid/graphics/Paint;
    ...
    iput-boolean v0, v1, Landroid/support/design/widget/d;->fw:Z
...
.method final ae()V
    ...
    .prologue
    .line 109
    iget-object v0, p0, Landroid/support/design/widget/l;->gy:Landroid/graphics/Rect;
    ...
    .line 112
    iget-object v1, p0, Landroid/support/design/widget/l;->in:Landroid/support/design/widget/p;
    ...
    invoke-interface {v1, v2, v3, v4, v0}, Landroid/support/design/widget/p;->c(IIII)V
