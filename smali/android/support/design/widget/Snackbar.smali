...
# static fields
.field private static final ja:Landroid/os/Handler;


# instance fields
.field final jb:Landroid/view/ViewGroup;

.field final jc:Landroid/support/design/widget/Snackbar$SnackbarLayout;

.field private final jd:Landroid/view/accessibility/AccessibilityManager;

.field final je:Landroid/support/design/widget/q$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/Snackbar;->ja:Landroid/os/Handler;
...
.method static synthetic a(Landroid/support/design/widget/Snackbar;)V
    ...
    iget-object v1, p0, Landroid/support/design/widget/Snackbar;->je:Landroid/support/design/widget/q$a;
    ...
    iget-object v1, v0, Landroid/support/design/widget/q;->jo:Landroid/support/design/widget/q$b;
    ...
    iget-object v1, v0, Landroid/support/design/widget/q;->jp:Landroid/support/design/widget/q$b;
...
.method static synthetic an()Landroid/os/Handler;
    ...
    .prologue
    .line 68
    sget-object v0, Landroid/support/design/widget/Snackbar;->ja:Landroid/os/Handler;
...
.method static synthetic b(Landroid/support/design/widget/Snackbar;)Landroid/support/design/widget/q$a;
    ...
    .prologue
    .line 68
    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->je:Landroid/support/design/widget/q$a;
...
.method static synthetic c(Landroid/support/design/widget/Snackbar;)Landroid/support/design/widget/Snackbar$SnackbarLayout;
    ...
    .prologue
    .line 68
    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->jc:Landroid/support/design/widget/Snackbar$SnackbarLayout;
...
.method final aj()V
    ...
    iget-object v1, p0, Landroid/support/design/widget/Snackbar;->jc:Landroid/support/design/widget/Snackbar$SnackbarLayout;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ah;->r(F)Landroid/support/v4/view/ah;

    move-result-object v0

    sget-object v1, Landroid/support/design/widget/a;->el:Landroid/view/animation/Interpolator;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ah;->b(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/ah;
    ...
    sget v1, Landroid/support/design/a$a;->P:I
...
.method final al()V
    ...
    iput-object v0, v1, Landroid/support/design/widget/q;->jo:Landroid/support/design/widget/q$b;

    iget-object v0, v1, Landroid/support/design/widget/q;->jp:Landroid/support/design/widget/q$b;
    ...
    iput-object v0, v1, Landroid/support/design/widget/q;->jp:Landroid/support/design/widget/q$b;

    iget-object v0, v1, Landroid/support/design/widget/q;->jo:Landroid/support/design/widget/q$b;

    iget-object v0, v0, Landroid/support/design/widget/q$b;->jr:Ljava/lang/ref/WeakReference;
...
.method final am()Z
    ...
    .prologue
    .line 638
    iget-object v0, p0, Landroid/support/design/widget/Snackbar;->jd:Landroid/view/accessibility/AccessibilityManager;
