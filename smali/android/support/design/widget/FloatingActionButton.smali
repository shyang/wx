...
# instance fields
.field private hD:Landroid/content/res/ColorStateList;

.field private hE:Landroid/graphics/PorterDuff$Mode;
...
.field private hL:Landroid/support/v7/widget/i;

.field private hM:Landroid/support/design/widget/l;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hK:Landroid/graphics/Rect;

    .line 116
    invoke-static {p1}, Landroid/support/design/widget/t;->g(Landroid/content/Context;)V

    .line 118
    sget-object v0, Landroid/support/design/a$i;->bO:[I

    sget v1, Landroid/support/design/a$h;->aJ:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hD:Landroid/content/res/ColorStateList;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hE:Landroid/graphics/PorterDuff$Mode;
    ...
    iput v0, p0, Landroid/support/design/widget/FloatingActionButton;->hG:I
    ...
    iput v0, p0, Landroid/support/design/widget/FloatingActionButton;->hH:I
    ...
    iput v0, p0, Landroid/support/design/widget/FloatingActionButton;->hF:I

    .line 127
    sget v0, Landroid/support/design/a$i;->bS:I
    ...
    .line 128
    sget v2, Landroid/support/design/a$i;->bU:I
    ...
    .line 130
    sget v3, Landroid/support/design/a$i;->bW:I

    invoke-virtual {v1, v3, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v3

    iput-boolean v3, p0, Landroid/support/design/widget/FloatingActionButton;->hJ:Z
    ...
    iput-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->hL:Landroid/support/v7/widget/i;

    .line 134
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->hL:Landroid/support/v7/widget/i;
    ...
    sget v3, Landroid/support/design/a$d;->aa:I
    ...
    iput v1, p0, Landroid/support/design/widget/FloatingActionButton;->hI:I
    ...
    iget-object v3, p0, Landroid/support/design/widget/FloatingActionButton;->hD:Landroid/content/res/ColorStateList;

    iget-object v4, p0, Landroid/support/design/widget/FloatingActionButton;->hE:Landroid/graphics/PorterDuff$Mode;

    iget v5, p0, Landroid/support/design/widget/FloatingActionButton;->hG:I

    iget v6, p0, Landroid/support/design/widget/FloatingActionButton;->hF:I
    ...
    iget v3, v1, Landroid/support/design/widget/l;->ij:F

    cmpl-float v3, v3, v0

    if-eqz v3, :cond_0

    iput v0, v1, Landroid/support/design/widget/l;->ij:F
    ...
    iget v1, v0, Landroid/support/design/widget/l;->ik:F

    cmpl-float v1, v1, v2

    if-eqz v1, :cond_1

    iput v2, v0, Landroid/support/design/widget/l;->ik:F
...
.method private X()Landroid/support/design/widget/l;
    ...
    .line 653
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hM:Landroid/support/design/widget/l;
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hM:Landroid/support/design/widget/l;
...
.method static synthetic c(Landroid/support/design/widget/FloatingActionButton;)Landroid/graphics/Rect;
    ...
    .prologue
    .line 61
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hK:Landroid/graphics/Rect;
...
.method static synthetic d(Landroid/support/design/widget/FloatingActionButton;)I
    ...
    .prologue
    .line 61
    iget v0, p0, Landroid/support/design/widget/FloatingActionButton;->hI:I
...
.method static synthetic e(Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .prologue
    .line 61
    iget-boolean v0, p0, Landroid/support/design/widget/FloatingActionButton;->hJ:Z
...
.method final W()I
    ...
    .prologue
    .line 349
    iget v0, p0, Landroid/support/design/widget/FloatingActionButton;->hH:I
    ...
    sget v1, Landroid/support/design/a$d;->ac:I
    ...
    sget v1, Landroid/support/design/a$d;->ab:I
...
.method public getBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 188
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hD:Landroid/content/res/ColorStateList;
...
.method public getBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    .prologue
    .line 215
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hE:Landroid/graphics/PorterDuff$Mode;
...
.method protected onAttachedToWindow()V
    ...
    iget-object v1, v0, Landroid/support/design/widget/l;->io:Landroid/view/ViewTreeObserver$OnPreDrawListener;
    ...
    iput-object v1, v0, Landroid/support/design/widget/l;->io:Landroid/view/ViewTreeObserver$OnPreDrawListener;

    :cond_0
    iget-object v1, v0, Landroid/support/design/widget/l;->im:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    iget-object v0, v0, Landroid/support/design/widget/l;->io:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method protected onDetachedFromWindow()V
    ...
    iget-object v2, v0, Landroid/support/design/widget/l;->io:Landroid/view/ViewTreeObserver$OnPreDrawListener;
...
.method protected onMeasure(II)V
    ...
    .line 158
    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton;->hK:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    add-int/2addr v1, v0

    iget-object v2, p0, Landroid/support/design/widget/FloatingActionButton;->hK:Landroid/graphics/Rect;
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 199
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->hD:Landroid/content/res/ColorStateList;
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    .line 228
    iput-object p1, p0, Landroid/support/design/widget/FloatingActionButton;->hE:Landroid/graphics/PorterDuff$Mode;
...
.method public setImageResource(I)V
    ...
    .prologue
    .line 251
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton;->hL:Landroid/support/v7/widget/i;
