...
# static fields
.field private static final hN:Z


# instance fields
.field private gy:Landroid/graphics/Rect;

.field private hO:Landroid/support/design/widget/u;
...
.method static constructor <clinit>()V
    ...
    :goto_0
    sput-boolean v0, Landroid/support/design/widget/FloatingActionButton$a;->hN:Z
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;Landroid/support/design/widget/FloatingActionButton;)Z
    ...
    .line 489
    iget v0, v0, Landroid/support/design/widget/CoordinatorLayout$d;->hq:I
    ...
    .line 495
    :cond_0
    iget v0, p3, Landroid/support/design/widget/VisibilityAwareImageButton;->lH:I
    ...
    .line 500
    :cond_1
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton$a;->gy:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/design/widget/FloatingActionButton$a;->gy:Landroid/graphics/Rect;
    ...
    invoke-static {p2}, Landroid/support/v4/view/y;->T(Landroid/view/View;)I
    ...
    invoke-static {v1}, Landroid/support/v4/view/y;->T(Landroid/view/View;)I
...
.method public final synthetic b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    iget-object v8, p1, Landroid/support/design/widget/CoordinatorLayout;->gV:Landroid/graphics/Rect;
    ...
    iget-object v9, p1, Landroid/support/design/widget/CoordinatorLayout;->gW:Landroid/graphics/Rect;
    ...
    :cond_4
    iget v0, p0, Landroid/support/design/widget/FloatingActionButton$a;->hP:F

    cmpl-float v0, v0, v4

    if-eqz v0, :cond_7

    invoke-static {p2}, Landroid/support/v4/view/y;->R(Landroid/view/View;)F

    move-result v0

    iget-object v1, p0, Landroid/support/design/widget/FloatingActionButton$a;->hO:Landroid/support/design/widget/u;
    ...
    iput-object v1, p0, Landroid/support/design/widget/FloatingActionButton$a;->hO:Landroid/support/design/widget/u;
    ...
    iget-object v0, p0, Landroid/support/design/widget/FloatingActionButton$a;->hO:Landroid/support/design/widget/u;
    ...
    :goto_5
    iput v4, p0, Landroid/support/design/widget/FloatingActionButton$a;->hP:F
    ...
    :cond_8
    invoke-static {p2, v4}, Landroid/support/v4/view/y;->c(Landroid/view/View;F)V
...
.method public final bridge synthetic e(Landroid/view/View;)Z
    ...
    .prologue
    .line 456
    sget-boolean v0, Landroid/support/design/widget/FloatingActionButton$a;->hN:Z
