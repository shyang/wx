...
.method public final handleMessage(Landroid/os/Message;)Z
    ...
    iget-object v1, v0, Landroid/support/design/widget/Snackbar;->jc:Landroid/support/design/widget/Snackbar$SnackbarLayout;
    ...
    iput v5, v4, Landroid/support/design/widget/s;->jD:F
    ...
    iput v5, v4, Landroid/support/design/widget/s;->jE:F

    iput v3, v4, Landroid/support/design/widget/s;->jB:I
    ...
    iput-object v3, v4, Landroid/support/design/widget/s;->jy:Landroid/support/design/widget/s$a;
    ...
    :cond_0
    iget-object v1, v0, Landroid/support/design/widget/Snackbar;->jb:Landroid/view/ViewGroup;

    iget-object v3, v0, Landroid/support/design/widget/Snackbar;->jc:Landroid/support/design/widget/Snackbar$SnackbarLayout;
    ...
    iput-object v3, v1, Landroid/support/design/widget/Snackbar$SnackbarLayout;->jm:Landroid/support/design/widget/Snackbar$SnackbarLayout$a;

    iget-object v1, v0, Landroid/support/design/widget/Snackbar;->jc:Landroid/support/design/widget/Snackbar$SnackbarLayout;

    invoke-static {v1}, Landroid/support/v4/view/y;->ai(Landroid/view/View;)Z
    ...
    iput-object v3, v1, Landroid/support/design/widget/Snackbar$SnackbarLayout;->jl:Landroid/support/design/widget/Snackbar$SnackbarLayout$b;
    ...
    iget-object v4, v0, Landroid/support/design/widget/Snackbar;->jc:Landroid/support/design/widget/Snackbar$SnackbarLayout;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/view/ah;->r(F)Landroid/support/v4/view/ah;

    move-result-object v3

    sget-object v4, Landroid/support/design/widget/a;->el:Landroid/view/animation/Interpolator;

    invoke-virtual {v3, v4}, Landroid/support/v4/view/ah;->b(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/ah;

    move-result-object v3

    invoke-virtual {v3, v8, v9}, Landroid/support/v4/view/ah;->d(J)Landroid/support/v4/view/ah;
    ...
    invoke-virtual {v3, v4}, Landroid/support/v4/view/ah;->a(Landroid/support/v4/view/al;)Landroid/support/v4/view/ah;
    ...
    sget v4, Landroid/support/design/a$a;->Q:I
    ...
    iget-object v0, v0, Landroid/support/design/widget/Snackbar;->jc:Landroid/support/design/widget/Snackbar$SnackbarLayout;
