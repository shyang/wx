...
.field private hU:Landroid/support/design/widget/r;

.field private hV:Z

.field hW:Landroid/support/design/widget/o;
...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/p;)V
    ...
    iput v0, p0, Landroid/support/design/widget/j;->hT:I
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->hU:Landroid/support/design/widget/r;

    .line 49
    iget-object v3, p0, Landroid/support/design/widget/j;->hU:Landroid/support/design/widget/r;
    ...
    iget-object v0, v3, Landroid/support/design/widget/r;->js:Ljava/util/ArrayList;
    ...
    :cond_1
    iput-object v7, v3, Landroid/support/design/widget/r;->eZ:Ljava/lang/ref/WeakReference;

    iput-object v7, v3, Landroid/support/design/widget/r;->jt:Landroid/support/design/widget/r$a;

    iput-object v7, v3, Landroid/support/design/widget/r;->ju:Landroid/view/animation/Animation;
    ...
    iput-object v0, v3, Landroid/support/design/widget/r;->eZ:Ljava/lang/ref/WeakReference;

    .line 52
    :cond_3
    iget-object v0, p0, Landroid/support/design/widget/j;->hU:Landroid/support/design/widget/r;
    ...
    sget-object v1, Landroid/support/design/widget/j;->il:[I
...
.method private c(Landroid/view/animation/Animation;)Landroid/view/animation/Animation;
    ...
    .line 226
    iget v0, p0, Landroid/support/design/widget/j;->hT:I
...
.method a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->if:Landroid/graphics/drawable/Drawable;

    .line 67
    iget-object v0, p0, Landroid/support/design/widget/j;->if:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->ig:Landroid/graphics/drawable/Drawable;

    .line 78
    iget-object v0, p0, Landroid/support/design/widget/j;->ig:Landroid/graphics/drawable/Drawable;

    new-array v1, v6, [[I

    new-array v2, v6, [I

    sget-object v3, Landroid/support/design/widget/j;->il:[I
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->ih:Landroid/support/design/widget/d;

    .line 83
    new-array v0, v6, [Landroid/graphics/drawable/Drawable;

    iget-object v1, p0, Landroid/support/design/widget/j;->ih:Landroid/support/design/widget/d;

    aput-object v1, v0, v7

    iget-object v1, p0, Landroid/support/design/widget/j;->if:Landroid/graphics/drawable/Drawable;

    aput-object v1, v0, v4

    iget-object v1, p0, Landroid/support/design/widget/j;->ig:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/j;->ii:Landroid/graphics/drawable/Drawable;

    .line 91
    new-instance v0, Landroid/support/design/widget/o;

    iget-object v1, p0, Landroid/support/design/widget/j;->im:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    iget-object v2, p0, Landroid/support/design/widget/j;->ii:Landroid/graphics/drawable/Drawable;

    iget-object v3, p0, Landroid/support/design/widget/j;->in:Landroid/support/design/widget/p;

    invoke-interface {v3}, Landroid/support/design/widget/p;->Y()F

    move-result v3

    iget v4, p0, Landroid/support/design/widget/j;->ij:F

    iget v5, p0, Landroid/support/design/widget/j;->ij:F

    iget v6, p0, Landroid/support/design/widget/j;->ik:F
    ...
    iput-object v0, p0, Landroid/support/design/widget/j;->hW:Landroid/support/design/widget/o;

    .line 97
    iget-object v0, p0, Landroid/support/design/widget/j;->hW:Landroid/support/design/widget/o;

    iput-boolean v7, v0, Landroid/support/design/widget/o;->iY:Z

    invoke-virtual {v0}, Landroid/support/design/widget/o;->invalidateSelf()V

    .line 98
    iget-object v0, p0, Landroid/support/design/widget/j;->in:Landroid/support/design/widget/p;

    iget-object v1, p0, Landroid/support/design/widget/j;->hW:Landroid/support/design/widget/o;
...
.method a(Landroid/support/design/widget/l$a;Z)V
    ...
    .prologue
    .line 158
    iget-boolean v0, p0, Landroid/support/design/widget/j;->hV:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/design/widget/j;->im:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    sget v1, Landroid/support/design/a$a;->O:I
...
.method aa()V
    ...
    iget-object v1, v0, Landroid/support/design/widget/r;->ju:Landroid/view/animation/Animation;
    ...
    iget-object v0, v0, Landroid/support/design/widget/r;->ju:Landroid/view/animation/Animation;
...
.method b(Landroid/support/design/widget/l$a;Z)V
    ...
    invoke-virtual {v0, v1, v1}, Landroid/support/design/widget/VisibilityAwareImageButton;->i(IZ)V
    ...
    sget v1, Landroid/support/design/a$a;->N:I
...
.method b([I)V
    ...
    iget-object v5, v0, Landroid/support/design/widget/r$a;->jx:[I
    ...
    :goto_1
    iget-object v0, v3, Landroid/support/design/widget/r;->jt:Landroid/support/design/widget/r$a;
    ...
    iget-object v0, v3, Landroid/support/design/widget/r;->ju:Landroid/view/animation/Animation;
    ...
    iget-object v5, v3, Landroid/support/design/widget/r;->ju:Landroid/view/animation/Animation;
    ...
    :cond_0
    iput-object v2, v3, Landroid/support/design/widget/r;->ju:Landroid/view/animation/Animation;

    :cond_1
    iput-object v1, v3, Landroid/support/design/widget/r;->jt:Landroid/support/design/widget/r$a;

    iget-object v0, v3, Landroid/support/design/widget/r;->eZ:Ljava/lang/ref/WeakReference;
    ...
    iput-object v0, v3, Landroid/support/design/widget/r;->ju:Landroid/view/animation/Animation;
    ...
    iget-object v1, v3, Landroid/support/design/widget/r;->ju:Landroid/view/animation/Animation;
...
.method i(F)V
    ...
    iget v1, p0, Landroid/support/design/widget/j;->ik:F
...
.method j(F)V
    ...
    iget v1, p0, Landroid/support/design/widget/j;->ij:F

    add-float/2addr v1, p1

    iget v2, v0, Landroid/support/design/widget/o;->iT:F
...
.method final setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    .line 106
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/j;->ih:Landroid/support/design/widget/d;
