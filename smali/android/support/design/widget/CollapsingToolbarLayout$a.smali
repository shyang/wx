...
# instance fields
.field final synthetic gJ:Landroid/support/design/widget/CollapsingToolbarLayout;
...
.method private constructor <init>(Landroid/support/design/widget/CollapsingToolbarLayout;)V
    ...
    .prologue
    .line 1107
    iput-object p1, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gJ:Landroid/support/design/widget/CollapsingToolbarLayout;
...
.method public final a(Landroid/support/design/widget/AppBarLayout;I)V
    ...
    .line 1110
    iget-object v0, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gJ:Landroid/support/design/widget/CollapsingToolbarLayout;
    ...
    invoke-static {v0}, Landroid/support/design/widget/CollapsingToolbarLayout;->a(Landroid/support/design/widget/CollapsingToolbarLayout;)Landroid/support/v4/view/ao;
    ...
    .line 1120
    iget v10, v0, Landroid/support/design/widget/CollapsingToolbarLayout$LayoutParams;->gK:I
    ...
    iget v0, v0, Landroid/support/design/widget/CollapsingToolbarLayout$LayoutParams;->gL:F
    ...
    .line 1135
    :cond_3
    iget-object v5, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gJ:Landroid/support/design/widget/CollapsingToolbarLayout;
    ...
    iget-object v7, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gJ:Landroid/support/design/widget/CollapsingToolbarLayout;

    invoke-static {v7}, Landroid/support/v4/view/y;->T(Landroid/view/View;)I
    ...
    :goto_3
    invoke-static {v5}, Landroid/support/v4/view/y;->ai(Landroid/view/View;)Z
    ...
    :goto_4
    iget-boolean v7, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gF:Z
    ...
    iget-object v3, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gG:Landroid/support/design/widget/u;
    ...
    iput-object v3, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gG:Landroid/support/design/widget/u;
    ...
    iget-object v4, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gG:Landroid/support/design/widget/u;

    iget v3, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gE:I
    ...
    iget v4, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gE:I

    invoke-virtual {v3, v4, v2}, Landroid/support/design/widget/u;->e(II)V

    iget-object v2, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gG:Landroid/support/design/widget/u;
    ...
    :goto_7
    iput-boolean v0, v5, Landroid/support/design/widget/CollapsingToolbarLayout;->gF:Z
    ...
    iget-object v2, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gJ:Landroid/support/design/widget/CollapsingToolbarLayout;
    ...
    .line 1145
    iget-object v1, p0, Landroid/support/design/widget/CollapsingToolbarLayout$a;->gJ:Landroid/support/design/widget/CollapsingToolbarLayout;
    ...
    .line 1151
    iget v0, p1, Landroid/support/design/widget/AppBarLayout;->et:F

    invoke-static {p1, v0}, Landroid/support/v4/view/y;->g(Landroid/view/View;F)V
    ...
    :cond_a
    sget-object v3, Landroid/support/design/widget/a;->en:Landroid/view/animation/Interpolator;
    ...
    iget-object v3, v3, Landroid/support/design/widget/u;->ld:Landroid/support/design/widget/u$e;
