...
.method static synthetic a(Landroid/support/design/widget/AppBarLayout$Behavior;)I
    ...
    .prologue
    .line 652
    iget v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ey:I
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;)V
    ...
    .line 866
    invoke-static {v3}, Landroid/support/v4/view/y;->T(Landroid/view/View;)I
...
.method private a(Landroid/support/design/widget/CoordinatorLayout;Landroid/support/design/widget/AppBarLayout;I)V
    ...
    .line 814
    iget-object v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eB:Landroid/support/design/widget/u;
    ...
    .line 820
    :cond_1
    iget-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eB:Landroid/support/design/widget/u;
    ...
    iput-object v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eB:Landroid/support/design/widget/u;
    ...
    .line 837
    iget-object v2, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eB:Landroid/support/design/widget/u;
...
.method final K()I
    ...
    iget v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ey:I
...
.method final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;III)I
    ...
    iget v3, v0, Landroid/support/design/widget/AppBarLayout$LayoutParams;->eN:I
    ...
    :cond_0
    :goto_1
    invoke-static {v7}, Landroid/support/v4/view/y;->Z(Landroid/view/View;)Z
    ...
    iput v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ey:I
    ...
    iget-object v0, p1, Landroid/support/design/widget/CoordinatorLayout;->gS:Ljava/util/List;
    ...
    iget-object v6, v1, Landroid/support/design/widget/CoordinatorLayout$d;->hm:Landroid/support/design/widget/CoordinatorLayout$Behavior;
    ...
    :cond_9
    iput v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ey:I
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)V
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eA:Z
    ...
    :cond_0
    iput-boolean v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ez:Z

    iput-boolean v1, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eA:Z
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;I[I)V
    ...
    iget-boolean v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ez:Z
...
.method public final synthetic a(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    iget-boolean v4, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eD:Z

    if-eqz v4, :cond_6

    invoke-static {v0}, Landroid/support/v4/view/y;->T(Landroid/view/View;)I
    ...
    iget v4, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->eE:F
...
.method public final synthetic b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Landroid/os/Parcelable;
    ...
    invoke-static {v6}, Landroid/support/v4/view/y;->T(Landroid/view/View;)I
...
.method public final synthetic b(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;I)V
    ...
    iput-boolean v0, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ez:Z

    :goto_0
    return-void

    :cond_0
    iput-boolean v5, p0, Landroid/support/design/widget/AppBarLayout$Behavior;->ez:Z
...
.method final synthetic d(Landroid/view/View;)Z
    ...
    invoke-static {v0, v1}, Landroid/support/v4/view/y;->g(Landroid/view/View;I)Z
