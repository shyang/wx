...
# instance fields
.field private ir:Landroid/graphics/drawable/InsetDrawable;
...
.method constructor <init>(Landroid/support/design/widget/VisibilityAwareImageButton;Landroid/support/design/widget/p;)V
    ...
    .line 46
    :cond_0
    iget-object v0, p0, Landroid/support/design/widget/m;->im:Landroid/support/design/widget/VisibilityAwareImageButton;
...
.method final a(Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;II)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/m;->if:Landroid/graphics/drawable/Drawable;

    .line 56
    iget-object v0, p0, Landroid/support/design/widget/m;->if:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Landroid/support/design/widget/m;->ih:Landroid/support/design/widget/d;
    ...
    iget-object v3, p0, Landroid/support/design/widget/m;->ih:Landroid/support/design/widget/d;

    aput-object v3, v1, v2

    const/4 v2, 0x1

    iget-object v3, p0, Landroid/support/design/widget/m;->if:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, p0, Landroid/support/design/widget/m;->ig:Landroid/graphics/drawable/Drawable;

    .line 73
    iget-object v0, p0, Landroid/support/design/widget/m;->ig:Landroid/graphics/drawable/Drawable;

    iput-object v0, p0, Landroid/support/design/widget/m;->ii:Landroid/graphics/drawable/Drawable;

    .line 75
    iget-object v0, p0, Landroid/support/design/widget/m;->in:Landroid/support/design/widget/p;

    iget-object v1, p0, Landroid/support/design/widget/m;->ig:Landroid/graphics/drawable/Drawable;
    ...
    .line 66
    :cond_1
    iput-object v4, p0, Landroid/support/design/widget/m;->ih:Landroid/support/design/widget/d;
...
.method final b(Landroid/graphics/Rect;)V
    ...
    .line 162
    iget-object v1, p0, Landroid/support/design/widget/m;->im:Landroid/support/design/widget/VisibilityAwareImageButton;

    invoke-virtual {v1}, Landroid/support/design/widget/VisibilityAwareImageButton;->getElevation()F

    move-result v1

    iget v2, p0, Landroid/support/design/widget/m;->ik:F
...
.method final c(Landroid/graphics/Rect;)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/m;->ir:Landroid/graphics/drawable/InsetDrawable;

    .line 128
    iget-object v0, p0, Landroid/support/design/widget/m;->in:Landroid/support/design/widget/p;

    iget-object v1, p0, Landroid/support/design/widget/m;->ir:Landroid/graphics/drawable/InsetDrawable;
...
.method final j(F)V
    ...
    iget-object v2, p0, Landroid/support/design/widget/m;->im:Landroid/support/design/widget/VisibilityAwareImageButton;
    ...
    .line 101
    sget-object v1, Landroid/support/design/widget/m;->il:[I
