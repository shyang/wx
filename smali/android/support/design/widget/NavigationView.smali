...
# instance fields
.field private final iD:Landroid/support/design/internal/a;

.field private final iE:Landroid/support/design/internal/b;

.field private iF:Landroid/support/design/widget/NavigationView$a;

.field private iG:I

.field private iH:Landroid/view/MenuInflater;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/design/widget/NavigationView;->dF:[I
    ...
    sput-object v0, Landroid/support/design/widget/NavigationView;->iC:[I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/NavigationView;->iE:Landroid/support/design/internal/b;
    ...
    iput-object v0, p0, Landroid/support/design/widget/NavigationView;->iD:Landroid/support/design/internal/a;

    .line 107
    sget-object v0, Landroid/support/design/a$i;->ch:[I

    sget v1, Landroid/support/design/a$h;->aK:I
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/y;->g(Landroid/view/View;F)V
    ...
    invoke-static {p0, v0}, Landroid/support/v4/view/y;->a(Landroid/view/View;Z)V
    ...
    iput v0, p0, Landroid/support/design/widget/NavigationView;->iG:I
    ...
    .line 131
    :goto_0
    sget v1, Landroid/support/design/a$i;->cp:I
    ...
    .line 137
    sget v7, Landroid/support/design/a$i;->cq:I
    ...
    .line 138
    sget v5, Landroid/support/design/a$i;->cq:I
    ...
    .line 146
    :cond_2
    sget v7, Landroid/support/design/a$i;->cn:I
    ...
    .line 148
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->iD:Landroid/support/design/internal/a;
    ...
    .line 157
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->iE:Landroid/support/design/internal/b;

    iput v4, v8, Landroid/support/design/internal/b;->dP:I

    .line 158
    iget-object v8, p0, Landroid/support/design/widget/NavigationView;->iE:Landroid/support/design/internal/b;

    iget-object v9, p0, Landroid/support/design/widget/NavigationView;->iD:Landroid/support/design/internal/a;
    ...
    .line 161
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->iE:Landroid/support/design/internal/b;
    ...
    .line 165
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->iD:Landroid/support/design/internal/a;

    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->iE:Landroid/support/design/internal/b;
    ...
    iget-object v0, v1, Landroid/support/design/internal/b;->dL:Landroid/support/design/internal/NavigationMenuView;

    if-nez v0, :cond_5

    iget-object v0, v1, Landroid/support/design/internal/b;->dR:Landroid/view/LayoutInflater;

    sget v3, Landroid/support/design/a$f;->ay:I
    ...
    iput-object v0, v1, Landroid/support/design/internal/b;->dL:Landroid/support/design/internal/NavigationMenuView;

    iget-object v0, v1, Landroid/support/design/internal/b;->dQ:Landroid/support/design/internal/b$b;
    ...
    iput-object v0, v1, Landroid/support/design/internal/b;->dQ:Landroid/support/design/internal/b$b;

    :cond_4
    iget-object v0, v1, Landroid/support/design/internal/b;->dR:Landroid/view/LayoutInflater;

    sget v3, Landroid/support/design/a$f;->av:I

    iget-object v5, v1, Landroid/support/design/internal/b;->dL:Landroid/support/design/internal/NavigationMenuView;
    ...
    iput-object v0, v1, Landroid/support/design/internal/b;->dM:Landroid/widget/LinearLayout;

    iget-object v0, v1, Landroid/support/design/internal/b;->dL:Landroid/support/design/internal/NavigationMenuView;

    iget-object v3, v1, Landroid/support/design/internal/b;->dQ:Landroid/support/design/internal/b$b;
    ...
    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->iH:Landroid/view/MenuInflater;
    ...
    iput-object v1, p0, Landroid/support/design/widget/NavigationView;->iH:Landroid/view/MenuInflater;

    :cond_6
    iget-object v1, p0, Landroid/support/design/widget/NavigationView;->iH:Landroid/view/MenuInflater;

    iget-object v3, p0, Landroid/support/design/widget/NavigationView;->iD:Landroid/support/design/internal/a;
    ...
    iget-object v3, v1, Landroid/support/design/internal/b;->dR:Landroid/view/LayoutInflater;

    iget-object v4, v1, Landroid/support/design/internal/b;->dM:Landroid/widget/LinearLayout;

    invoke-virtual {v3, v0, v4, v2}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    move-result-object v0

    iget-object v3, v1, Landroid/support/design/internal/b;->dM:Landroid/widget/LinearLayout;

    invoke-virtual {v3, v0}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;)V

    iget-object v0, v1, Landroid/support/design/internal/b;->dL:Landroid/support/design/internal/NavigationMenuView;

    iget-object v1, v1, Landroid/support/design/internal/b;->dL:Landroid/support/design/internal/NavigationMenuView;
...
.method static synthetic a(Landroid/support/design/widget/NavigationView;)Landroid/support/design/widget/NavigationView$a;
    ...
    .prologue
    .line 75
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->iF:Landroid/support/design/widget/NavigationView$a;
...
.method private v(I)Landroid/content/res/ColorStateList;
    ...
    sget-object v5, Landroid/support/design/widget/NavigationView;->iC:[I

    aput-object v5, v4, v8

    sget-object v5, Landroid/support/design/widget/NavigationView;->dF:[I
    ...
    sget-object v6, Landroid/support/design/widget/NavigationView;->iC:[I
...
.method protected final a(Landroid/graphics/Rect;)V
    ...
    iget v2, v0, Landroid/support/design/internal/b;->dW:I

    if-eq v2, v1, :cond_0

    iput v1, v0, Landroid/support/design/internal/b;->dW:I

    iget-object v1, v0, Landroid/support/design/internal/b;->dM:Landroid/widget/LinearLayout;
    ...
    iget-object v1, v0, Landroid/support/design/internal/b;->dL:Landroid/support/design/internal/NavigationMenuView;

    iget v2, v0, Landroid/support/design/internal/b;->dW:I

    iget-object v0, v0, Landroid/support/design/internal/b;->dL:Landroid/support/design/internal/NavigationMenuView;
...
.method protected onMeasure(II)V
    ...
    iget v1, p0, Landroid/support/design/widget/NavigationView;->iG:I
    ...
    .line 219
    :sswitch_2
    iget v0, p0, Landroid/support/design/widget/NavigationView;->iG:I
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 196
    iget-object v2, p0, Landroid/support/design/widget/NavigationView;->iD:Landroid/support/design/internal/a;

    iget-object v0, p1, Landroid/support/design/widget/NavigationView$SavedState;->iJ:Landroid/os/Bundle;
    ...
    iget-object v0, v2, Landroid/support/v7/view/menu/f;->PF:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iget-object v1, v2, Landroid/support/v7/view/menu/f;->PF:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iput-object v0, v1, Landroid/support/design/widget/NavigationView$SavedState;->iJ:Landroid/os/Bundle;

    .line 184
    iget-object v0, p0, Landroid/support/design/widget/NavigationView;->iD:Landroid/support/design/internal/a;

    iget-object v2, v1, Landroid/support/design/widget/NavigationView$SavedState;->iJ:Landroid/os/Bundle;
