...
# instance fields
.field final synthetic dY:Landroid/support/design/internal/b;

.field final dZ:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private ea:Landroid/support/v7/view/menu/h;

.field private eb:Landroid/graphics/drawable/ColorDrawable;
...
.method public constructor <init>(Landroid/support/design/internal/b;)V
    ...
    .prologue
    .line 343
    iput-object p1, p0, Landroid/support/design/internal/b$b;->dY:Landroid/support/design/internal/b;
    ...
    iput-object v0, p0, Landroid/support/design/internal/b$b;->dZ:Ljava/util/ArrayList;
...
.method private b(II)V
    ...
    .line 517
    iget-object v0, p0, Landroid/support/design/internal/b$b;->dZ:Ljava/util/ArrayList;
    ...
    .line 518
    iget-object v0, v0, Landroid/support/design/internal/b$f;->ef:Landroid/support/v7/view/menu/h;
    ...
    .line 520
    iget-object v1, p0, Landroid/support/design/internal/b$b;->eb:Landroid/graphics/drawable/ColorDrawable;
    ...
    iput-object v1, p0, Landroid/support/design/internal/b$b;->eb:Landroid/graphics/drawable/ColorDrawable;
...
.method final F()V
    ...
    .prologue
    .line 445
    iget-boolean v0, p0, Landroid/support/design/internal/b$b;->ec:Z
    ...
    iput-boolean v0, p0, Landroid/support/design/internal/b$b;->ec:Z
    ...
    iget-object v1, p0, Landroid/support/design/internal/b$b;->dY:Landroid/support/design/internal/b;

    iget-object v1, v1, Landroid/support/design/internal/b;->dO:Landroid/support/v7/view/menu/f;

    invoke-virtual {v1}, Landroid/support/v7/view/menu/f;->dD()Ljava/util/ArrayList;
    ...
    .line 456
    iget-object v0, p0, Landroid/support/design/internal/b$b;->dY:Landroid/support/design/internal/b;

    iget-object v0, v0, Landroid/support/design/internal/b;->dO:Landroid/support/v7/view/menu/f;
    ...
    .line 467
    iget-object v1, p0, Landroid/support/design/internal/b$b;->dZ:Ljava/util/ArrayList;

    new-instance v2, Landroid/support/design/internal/b$e;

    iget-object v6, p0, Landroid/support/design/internal/b$b;->dY:Landroid/support/design/internal/b;

    iget v6, v6, Landroid/support/design/internal/b;->dX:I
    ...
    .line 484
    :cond_6
    iget-object v12, p0, Landroid/support/design/internal/b$b;->dZ:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Landroid/support/design/internal/b$b;->dY:Landroid/support/design/internal/b;

    iget v5, v5, Landroid/support/design/internal/b;->dX:I

    iget-object v9, p0, Landroid/support/design/internal/b$b;->dY:Landroid/support/design/internal/b;

    iget v9, v9, Landroid/support/design/internal/b;->dX:I
    ...
    .line 508
    :cond_b
    iget-object v3, p0, Landroid/support/design/internal/b$b;->dZ:Ljava/util/ArrayList;
...
.method public final G()Landroid/os/Bundle;
    ...
    .line 541
    iget-object v0, p0, Landroid/support/design/internal/b$b;->ea:Landroid/support/v7/view/menu/h;
    ...
    iget-object v2, p0, Landroid/support/design/internal/b$b;->ea:Landroid/support/v7/view/menu/h;
    ...
    iget-object v4, v0, Landroid/support/design/internal/b$f;->ef:Landroid/support/v7/view/menu/h;
...
.method public final synthetic a(Landroid/view/ViewGroup;I)Landroid/support/v7/widget/RecyclerView$s;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->dR:Landroid/view/LayoutInflater;

    iget-object v2, p0, Landroid/support/design/internal/b$b;->dY:Landroid/support/design/internal/b;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->dM:Landroid/widget/LinearLayout;
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$s;)V
    ...
    iget-object v0, p1, Landroid/support/design/internal/b$j;->ZY:Landroid/view/View;

    check-cast v0, Landroid/support/design/internal/NavigationMenuItemView;

    iget-object v1, v0, Landroid/support/design/internal/NavigationMenuItemView;->dI:Landroid/widget/FrameLayout;
    ...
    :cond_0
    iget-object v0, v0, Landroid/support/design/internal/NavigationMenuItemView;->dH:Landroid/widget/CheckedTextView;
...
.method public final synthetic a(Landroid/support/v7/widget/RecyclerView$s;I)V
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->dK:Landroid/content/res/ColorStateList;

    iput-object v1, v0, Landroid/support/design/internal/NavigationMenuItemView;->dK:Landroid/content/res/ColorStateList;

    iget-object v1, v0, Landroid/support/design/internal/NavigationMenuItemView;->dJ:Landroid/support/v7/view/menu/h;
    ...
    iget-boolean v1, v1, Landroid/support/design/internal/b;->dT:Z
    ...
    iget v2, v2, Landroid/support/design/internal/b;->dS:I

    iget-object v3, v0, Landroid/support/design/internal/NavigationMenuItemView;->dH:Landroid/widget/CheckedTextView;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->dU:Landroid/content/res/ColorStateList;
    ...
    iget-object v2, v0, Landroid/support/design/internal/NavigationMenuItemView;->dH:Landroid/widget/CheckedTextView;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b;->dV:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v1, Landroid/support/design/internal/b$f;->ef:Landroid/support/v7/view/menu/h;
    ...
    iget-object v1, p1, Landroid/support/design/internal/b$j;->ZY:Landroid/view/View;

    iget v2, v0, Landroid/support/design/internal/b$e;->ed:I

    iget v0, v0, Landroid/support/design/internal/b$e;->ee:I
...
.method public final d(Landroid/support/v7/view/menu/h;)V
    ...
    .line 535
    :cond_2
    iput-object p1, p0, Landroid/support/design/internal/b$b;->ea:Landroid/support/v7/view/menu/h;
