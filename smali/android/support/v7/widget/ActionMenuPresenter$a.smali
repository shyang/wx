...
.method public constructor <init>(Landroid/support/v7/widget/ActionMenuPresenter;Landroid/content/Context;Landroid/support/v7/view/menu/p;)V
    ...
    .line 719
    iput-object p1, p0, Landroid/support/v7/widget/ActionMenuPresenter$a;->RS:Landroid/support/v7/widget/ActionMenuPresenter;
    ...
    .line 722
    iput-object p3, p0, Landroid/support/v7/widget/ActionMenuPresenter$a;->PL:Landroid/support/v7/view/menu/p;
    ...
    .line 727
    iget-object v0, p1, Landroid/support/v7/widget/ActionMenuPresenter;->Rx:Landroid/support/v7/widget/ActionMenuPresenter$d;

    if-nez v0, :cond_2

    iget-object v0, p1, Landroid/support/v7/widget/ActionMenuPresenter;->OT:Landroid/support/v7/view/menu/m;

    check-cast v0, Landroid/view/View;

    :goto_0
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->hr:Landroid/view/View;
    ...
    .line 741
    :cond_1
    iput-boolean v4, p0, Landroid/support/v7/view/menu/k;->Pf:Z
...
.method public final onDismiss()V
    ...
    .line 747
    iget-object v0, p0, Landroid/support/v7/widget/ActionMenuPresenter$a;->RS:Landroid/support/v7/widget/ActionMenuPresenter;

    const/4 v1, 0x0

    iput-object v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->RN:Landroid/support/v7/widget/ActionMenuPresenter$a;
    ...
    iput v1, v0, Landroid/support/v7/widget/ActionMenuPresenter;->RR:I
