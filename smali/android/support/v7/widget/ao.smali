...
# instance fields
.field public final adz:Landroid/content/res/TypedArray;
...
.method private constructor <init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    .line 52
    iput-object p1, p0, Landroid/support/v7/widget/ao;->mContext:Landroid/content/Context;

    .line 53
    iput-object p2, p0, Landroid/support/v7/widget/ao;->adz:Landroid/content/res/TypedArray;

    .line 54
    return-void
.end method

.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroid/support/v7/widget/ao;
    .locals 2
    ...
    invoke-direct {v1, p0, v0}, Landroid/support/v7/widget/ao;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    return-object v1
.end method

.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;[II)Landroid/support/v7/widget/ao;
    .locals 2
...
# virtual methods
.method public final bw(I)Landroid/graphics/drawable/Drawable;
    .locals 4

    .prologue
    .line 67
    iget-object v0, p0, Landroid/support/v7/widget/ao;->adz:Landroid/content/res/TypedArray;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ao;->mContext:Landroid/content/Context;
