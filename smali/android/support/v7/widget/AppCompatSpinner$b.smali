...
.field final synthetic Uf:Landroid/support/v7/widget/AppCompatSpinner;
...
.method public constructor <init>(Landroid/support/v7/widget/AppCompatSpinner;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .prologue
    .line 701
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->Uf:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->Uj:Landroid/graphics/Rect;

    .line 704
    iput-object p1, p0, Landroid/support/v7/widget/ListPopupWindow;->Xa:Landroid/view/View;

    .line 705
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$b;->fi()V

    .line 706
    const/4 v0, 0x0

    iput v0, p0, Landroid/support/v7/widget/ListPopupWindow;->WY:I
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ListPopupWindow;->Xc:Landroid/widget/AdapterView$OnItemClickListener;
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner$b;)Landroid/widget/ListAdapter;
    ...
    .prologue
    .line 696
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->EC:Landroid/widget/ListAdapter;
...
.method static synthetic a(Landroid/support/v7/widget/AppCompatSpinner$b;Landroid/view/View;)Z
    ...
    .prologue
    .line 696
    invoke-static {p1}, Landroid/support/v4/view/y;->ak(Landroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->Uj:Landroid/graphics/Rect;
...
.method final eE()V
    ...
    .line 740
    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->Uf:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/ar;->bu(Landroid/view/View;)Z
    ...
    .line 751
    iget-object v2, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->Uf:Landroid/support/v7/widget/AppCompatSpinner;

    iget-object v0, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->EC:Landroid/widget/ListAdapter;

    check-cast v0, Landroid/widget/SpinnerAdapter;

    iget-object v6, p0, Landroid/support/v7/widget/ListPopupWindow;->WN:Landroid/widget/PopupWindow;
    ...
    iget-object v6, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->Uf:Landroid/support/v7/widget/AppCompatSpinner;
    ...
    iget v2, p0, Landroid/support/v7/widget/ListPopupWindow;->Ud:I
    ...
    .line 770
    :goto_4
    iput v0, p0, Landroid/support/v7/widget/ListPopupWindow;->WQ:I
    ...
    .line 744
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->Uf:Landroid/support/v7/widget/AppCompatSpinner;
...
.method public final setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 724
    iput-object p1, p0, Landroid/support/v7/widget/AppCompatSpinner$b;->EC:Landroid/widget/ListAdapter;
...
.method public final show()V
    ...
    .line 776
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$b;->eE()V

    .line 778
    invoke-virtual {p0}, Landroid/support/v7/widget/AppCompatSpinner$b;->fj()V

    .line 779
    invoke-super {p0}, Landroid/support/v7/widget/ListPopupWindow;->show()V

    .line 780
    iget-object v1, p0, Landroid/support/v7/widget/ListPopupWindow;->WO:Landroid/support/v7/widget/ListPopupWindow$a;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ListPopupWindow;->WO:Landroid/support/v7/widget/ListPopupWindow$a;
