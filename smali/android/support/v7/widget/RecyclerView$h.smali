...
.field Zd:Landroid/support/v7/widget/RecyclerView;

.field Ze:Landroid/support/v7/widget/RecyclerView$o;
...
.method public constructor <init>()V
    ...
    .line 5979
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zf:Z

    .line 5981
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->ha:Z

    .line 5983
    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zg:Z

    .line 5989
    const/4 v0, 0x1

    iput-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zh:Z
...
.method static synthetic a(Landroid/support/v7/widget/RecyclerView$h;Landroid/support/v7/widget/RecyclerView$o;)V
    ...
    .prologue
    .line 5972
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Ze:Landroid/support/v7/widget/RecyclerView$o;

    if-ne v0, p1, :cond_0

    const/4 v0, 0x0

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Ze:Landroid/support/v7/widget/RecyclerView$o;
...
.method private aW(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->XU:Landroid/support/v7/widget/s;
...
.method static synthetic b(Landroid/support/v7/widget/RecyclerView$h;)Z
    ...
    .prologue
    .line 5972
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zg:Z
...
.method static synthetic c(Landroid/support/v7/widget/RecyclerView$h;)Z
    ...
    .prologue
    .line 5972
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zf:Z
...
.method private removeViewAt(I)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v7/widget/s;->aL(I)I

    move-result v1

    iget-object v2, v0, Landroid/support/v7/widget/s;->UJ:Landroid/support/v7/widget/s$b;
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/s$a;->aN(I)Z
    ...
    :cond_0
    iget-object v0, v0, Landroid/support/v7/widget/s;->UJ:Landroid/support/v7/widget/s$b;
...
.method final M(II)V
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zk:I
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zi:I

    .line 6025
    iget v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zi:I

    if-nez v0, :cond_0

    sget-boolean v0, Landroid/support/v7/widget/RecyclerView;->XO:Z

    if-nez v0, :cond_0

    .line 6026
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Zk:I
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$h;->QO:I
    ...
    iput v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zj:I

    .line 6031
    iget v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zj:I
    ...
    .line 6032
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$h;->QO:I
...
.method final N(II)V
    ...
    invoke-virtual {v0, p1, p2}, Landroid/support/v7/widget/RecyclerView;->L(II)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/RecyclerView;->q(Landroid/support/v7/widget/RecyclerView;)Landroid/graphics/Rect;
...
.method public final a(ILandroid/support/v7/widget/RecyclerView$l;)V
    ...
    .line 7039
    invoke-virtual {p2, v0}, Landroid/support/v7/widget/RecyclerView$l;->bl(Landroid/view/View;)V
...
.method public a(Landroid/graphics/Rect;II)V
    ...
    invoke-static {p2, v0, v2}, Landroid/support/v7/widget/RecyclerView$h;->j(III)I
    ...
    invoke-static {p3, v1, v2}, Landroid/support/v7/widget/RecyclerView$h;->j(III)I
...
.method public final a(Landroid/view/View;Landroid/support/v7/widget/RecyclerView$l;)V
    ...
    iget-object v2, v0, Landroid/support/v7/widget/s;->UK:Landroid/support/v7/widget/s$a;

    invoke-virtual {v2, v1}, Landroid/support/v7/widget/s$a;->aN(I)Z
    ...
    .line 7027
    :cond_1
    invoke-virtual {p2, p1}, Landroid/support/v7/widget/RecyclerView$l;->bl(Landroid/view/View;)V
...
.method final a(Landroid/view/View;IILandroid/support/v7/widget/RecyclerView$LayoutParams;)Z
    ...
    iget-boolean v0, p0, Landroid/support/v7/widget/RecyclerView$h;->Zh:Z
    ...
    invoke-static {v0, p2, v1}, Landroid/support/v7/widget/RecyclerView$h;->k(III)Z
    ...
    invoke-static {v0, p3, v1}, Landroid/support/v7/widget/RecyclerView$h;->k(III)Z
...
.method public aX(I)V
    ...
    iget-object v0, v1, Landroid/support/v7/widget/RecyclerView;->XU:Landroid/support/v7/widget/s;
    ...
    iget-object v3, v1, Landroid/support/v7/widget/RecyclerView;->XU:Landroid/support/v7/widget/s;
...
.method public final b(Landroid/support/v7/widget/RecyclerView$l;)V
    .locals 4
    ...
    .line 7298
    invoke-static {v1}, Landroid/support/v7/widget/RecyclerView;->aY(Landroid/view/View;)Landroid/support/v7/widget/RecyclerView$s;

    move-result-object v2

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$s;->gf()Z

    move-result v3

    if-nez v3, :cond_0

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$s;->gn()Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$s;->isRemoved()Z

    move-result v3

    if-nez v3, :cond_1

    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$h;->Zd:Landroid/support/v7/widget/RecyclerView;
    ...
    invoke-virtual {p1, v2}, Landroid/support/v7/widget/RecyclerView$l;->n(Landroid/support/v7/widget/RecyclerView$s;)V
    ...
    .line 7298
    :cond_1
    invoke-direct {p0, v0}, Landroid/support/v7/widget/RecyclerView$h;->aW(I)V

    invoke-virtual {p1, v1}, Landroid/support/v7/widget/RecyclerView$l;->bn(Landroid/view/View;)V

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Zd:Landroid/support/v7/widget/RecyclerView;

    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->XV:Landroid/support/v7/widget/aq;

    invoke-virtual {v1, v2}, Landroid/support/v7/widget/aq;->A(Landroid/support/v7/widget/RecyclerView$s;)V
...
.method final b(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$l;)V
    ...
    .line 6281
    invoke-virtual {p0, p1, p2}, Landroid/support/v7/widget/RecyclerView$h;->a(Landroid/support/v7/widget/RecyclerView;Landroid/support/v7/widget/RecyclerView$l;)V
...
.method public final be(Landroid/view/View;)Landroid/view/View;
    ...
    .line 6837
    :cond_4
    iget-object v2, p0, Landroid/support/v7/widget/RecyclerView$h;->XU:Landroid/support/v7/widget/s;
...
.method final c(Landroid/support/v7/widget/RecyclerView$l;)V
    .locals 6
    ...
    .line 7331
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$l;->Zr:Ljava/util/ArrayList;
    ...
    .line 7337
    invoke-virtual {v3, v5}, Landroid/support/v7/widget/RecyclerView$s;->S(Z)V

    .line 7345
    invoke-virtual {v3}, Landroid/support/v7/widget/RecyclerView$s;->gp()Z
    ...
    iget-object v4, v4, Landroid/support/v7/widget/RecyclerView;->Yv:Landroid/support/v7/widget/RecyclerView$e;
    ...
    invoke-virtual {v4, v3}, Landroid/support/v7/widget/RecyclerView$e;->d(Landroid/support/v7/widget/RecyclerView$s;)V

    .line 7351
    :cond_1
    const/4 v4, 0x1

    invoke-virtual {v3, v4}, Landroid/support/v7/widget/RecyclerView$s;->S(Z)V

    .line 7352
    invoke-virtual {p1, v0}, Landroid/support/v7/widget/RecyclerView$l;->bm(Landroid/view/View;)V
    ...
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView$l;->Zs:Ljava/util/ArrayList;
...
.method c(Landroid/view/View;IZ)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aq;->z(Landroid/support/v7/widget/RecyclerView$s;)V
    ...
    .line 6703
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$s;->gk()Z

    move-result v1

    if-nez v1, :cond_1

    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$s;->gi()Z
    ...
    .line 6705
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$s;->gj()V
    ...
    :cond_2
    :goto_2
    iget-boolean v1, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Zn:Z

    if-eqz v1, :cond_3

    .line 6738
    iget-object v1, v2, Landroid/support/v7/widget/RecyclerView$s;->ZY:Landroid/view/View;

    invoke-virtual {v1}, Landroid/view/View;->invalidate()V

    .line 6739
    iput-boolean v7, v0, Landroid/support/v7/widget/RecyclerView$LayoutParams;->Zn:Z
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/aq;->A(Landroid/support/v7/widget/RecyclerView$s;)V

    goto :goto_0

    .line 6707
    :cond_5
    invoke-virtual {v2}, Landroid/support/v7/widget/RecyclerView$s;->gl()V
    ...
    .line 6717
    iget-object v3, p0, Landroid/support/v7/widget/RecyclerView$h;->XU:Landroid/support/v7/widget/s;
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->XZ:Landroid/support/v7/widget/RecyclerView$h;
    ...
    :cond_9
    invoke-direct {v3, v1}, Landroid/support/v7/widget/RecyclerView$h;->aW(I)V
    ...
    invoke-virtual {v5}, Landroid/support/v7/widget/RecyclerView$s;->isRemoved()Z

    move-result v6

    if-eqz v6, :cond_a

    iget-object v6, v3, Landroid/support/v7/widget/RecyclerView$h;->Zd:Landroid/support/v7/widget/RecyclerView;

    iget-object v6, v6, Landroid/support/v7/widget/RecyclerView;->XV:Landroid/support/v7/widget/aq;

    invoke-virtual {v6, v5}, Landroid/support/v7/widget/aq;->z(Landroid/support/v7/widget/RecyclerView$s;)V

    :goto_3
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView$h;->XU:Landroid/support/v7/widget/s;
    ...
    invoke-virtual {v6, v5}, Landroid/support/v7/widget/aq;->A(Landroid/support/v7/widget/RecyclerView$s;)V
    ...
    .line 6730
    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Ze:Landroid/support/v7/widget/RecyclerView$o;

    if-eqz v1, :cond_2

    iget-object v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Ze:Landroid/support/v7/widget/RecyclerView$o;

    iget-boolean v1, v1, Landroid/support/v7/widget/RecyclerView$o;->ZB:Z
    ...
    iget v4, v1, Landroid/support/v7/widget/RecyclerView$o;->Zz:I

    if-ne v3, v4, :cond_2

    iput-object p1, v1, Landroid/support/v7/widget/RecyclerView$o;->ZC:Landroid/view/View;
...
.method public final d(Landroid/support/v7/widget/RecyclerView$l;)V
    .locals 2
    ...
    invoke-virtual {v1}, Landroid/support/v7/widget/RecyclerView$s;->gf()Z
...
.method public abstract eR()Landroid/support/v7/widget/RecyclerView$LayoutParams;
.end method
...
.method public final fW()Z
    ...
    iget-boolean v0, v0, Landroid/support/v7/widget/RecyclerView$o;->ZB:Z
...
.method final fX()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/RecyclerView$o;->stop()V
...
.method public onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    iget-object v1, v1, Landroid/support/v7/widget/RecyclerView;->XR:Landroid/support/v7/widget/RecyclerView$l;
    ...
    invoke-static {v2, v0}, Landroid/support/v4/view/y;->g(Landroid/view/View;I)Z
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/y;->g(Landroid/view/View;I)Z
    ...
    invoke-static {v2, v3}, Landroid/support/v4/view/y;->f(Landroid/view/View;I)Z
    ...
    invoke-static {v2, v0}, Landroid/support/v4/view/y;->f(Landroid/view/View;I)Z
...
.method final t(Landroid/support/v7/widget/RecyclerView;)V
    .locals 3
    ...
    .line 6008
    iput-object v2, p0, Landroid/support/v7/widget/RecyclerView$h;->Zd:Landroid/support/v7/widget/RecyclerView;

    .line 6009
    iput-object v2, p0, Landroid/support/v7/widget/RecyclerView$h;->XU:Landroid/support/v7/widget/s;
    ...
    .line 6018
    :goto_0
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Zi:I

    .line 6019
    iput v1, p0, Landroid/support/v7/widget/RecyclerView$h;->Zj:I
    ...
    .line 6013
    :cond_0
    iput-object p1, p0, Landroid/support/v7/widget/RecyclerView$h;->Zd:Landroid/support/v7/widget/RecyclerView;

    .line 6014
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->XU:Landroid/support/v7/widget/s;

    iput-object v0, p0, Landroid/support/v7/widget/RecyclerView$h;->XU:Landroid/support/v7/widget/s;
...
.method final u(Landroid/support/v7/widget/RecyclerView;)V
    .locals 3
    ...
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/RecyclerView$h;->M(II)V
