...
# instance fields
.field private final Bw:Landroid/content/res/Resources;
...
.field public PF:Ljava/util/concurrent/CopyOnWriteArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field PG:Landroid/support/v7/view/menu/h;
...
.field public Pp:Landroid/support/v7/view/menu/f$a;
...
.field private Pw:Landroid/view/ContextMenu$ContextMenuInfo;

.field Px:Ljava/lang/CharSequence;

.field Py:Landroid/graphics/drawable/Drawable;

.field Pz:Landroid/view/View;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/view/menu/f;->Pm:[I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 129
    iput v1, p0, Landroid/support/v7/view/menu/f;->Pv:I

    .line 160
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->PA:Z

    .line 162
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->PB:Z

    .line 164
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->PC:Z

    .line 166
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->PD:Z
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->PE:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->PF:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->Bw:Landroid/content/res/Resources;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->dZ:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->Pq:Ljava/util/ArrayList;

    .line 221
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->Pr:Z
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->Ps:Ljava/util/ArrayList;
    ...
    iput-object v2, p0, Landroid/support/v7/view/menu/f;->Pt:Ljava/util/ArrayList;

    .line 225
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->Pu:Z

    .line 227
    iget-object v2, p0, Landroid/support/v7/view/menu/f;->Bw:Landroid/content/res/Resources;
    ...
    sget v3, Landroid/support/v7/a/a$b;->HO:I
    ...
    :goto_0
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->Po:Z
...
.method private a(ILandroid/view/KeyEvent;)Landroid/support/v7/view/menu/h;
    ...
    .line 903
    iget-object v5, p0, Landroid/support/v7/view/menu/f;->PE:Ljava/util/ArrayList;
    ...
    .line 922
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->dx()Z
...
.method private a(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    .line 870
    :cond_1
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->dZ:Ljava/util/ArrayList;
...
.method private static b(Ljava/util/ArrayList;I)I
    ...
    .line 826
    iget v0, v0, Landroid/support/v7/view/menu/h;->Ox:I
...
.method public final D(Z)V
    ...
    .prologue
    .line 997
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->PD:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->PD:Z

    .line 1000
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->PF:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    .line 1003
    iget-object v1, p0, Landroid/support/v7/view/menu/f;->PF:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final a(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    sget-object v1, Landroid/support/v7/view/menu/f;->Pm:[I
    ...
    .line 435
    iget v7, p0, Landroid/support/v7/view/menu/f;->Pv:I
    ...
    .line 438
    iget-object v1, p0, Landroid/support/v7/view/menu/f;->Pw:Landroid/view/ContextMenu$ContextMenuInfo;
    ...
    iput-object v1, v0, Landroid/support/v7/view/menu/h;->PS:Landroid/view/ContextMenu$ContextMenuInfo;

    .line 443
    :cond_2
    iget-object v1, p0, Landroid/support/v7/view/menu/f;->dZ:Ljava/util/ArrayList;

    iget-object v2, p0, Landroid/support/v7/view/menu/f;->dZ:Ljava/util/ArrayList;

    invoke-static {v2, v5}, Landroid/support/v7/view/menu/f;->b(Ljava/util/ArrayList;I)I
...
.method public a(Landroid/support/v7/view/menu/f$a;)V
    ...
    .prologue
    .line 426
    iput-object p1, p0, Landroid/support/v7/view/menu/f;->Pp:Landroid/support/v7/view/menu/f$a;
...
.method final a(Ljava/lang/CharSequence;Landroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    .line 1187
    iput-object p3, p0, Landroid/support/v7/view/menu/f;->Pz:Landroid/view/View;

    .line 1190
    iput-object v0, p0, Landroid/support/v7/view/menu/f;->Px:Ljava/lang/CharSequence;

    .line 1191
    iput-object v0, p0, Landroid/support/v7/view/menu/f;->Py:Landroid/graphics/drawable/Drawable;
    ...
    .line 1196
    iput-object p1, p0, Landroid/support/v7/view/menu/f;->Px:Ljava/lang/CharSequence;
    ...
    .line 1202
    iput-object p2, p0, Landroid/support/v7/view/menu/f;->Py:Landroid/graphics/drawable/Drawable;

    .line 1206
    :cond_2
    iput-object v0, p0, Landroid/support/v7/view/menu/f;->Pz:Landroid/view/View;
...
.method public final a(Landroid/view/MenuItem;Landroid/support/v7/view/menu/l;I)Z
    ...
    .line 960
    iget-object v4, p1, Landroid/support/v7/view/menu/h;->PP:Landroid/support/v4/view/d;
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/f;->PF:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public add(I)Landroid/view/MenuItem;
    ...
    .line 462
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Bw:Landroid/content/res/Resources;
...
.method b(Landroid/support/v7/view/menu/f;Landroid/view/MenuItem;)Z
    ...
    .prologue
    .line 811
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Pp:Landroid/support/v7/view/menu/f$a;
...
.method public clear()V
    ...
    .prologue
    .line 584
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->PG:Landroid/support/v7/view/menu/h;
...
.method public final dA()V
    ...
    .line 1051
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->PB:Z
...
.method public final dD()Ljava/util/ArrayList;
    ...
    .line 1080
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Pr:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Pq:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/f;->Pq:Ljava/util/ArrayList;
    ...
    .line 1092
    :cond_2
    iput-boolean v2, p0, Landroid/support/v7/view/menu/f;->Pr:Z
...
.method public final dE()V
    ...
    .line 1125
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->dD()Ljava/util/ArrayList;

    move-result-object v4

    .line 1127
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Pu:Z
    ...
    .line 1143
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Ps:Ljava/util/ArrayList;

    invoke-virtual {v0}, Ljava/util/ArrayList;->clear()V

    .line 1144
    iget-object v0, p0, Landroid/support/v7/view/menu/f;->Pt:Ljava/util/ArrayList;
    ...
    .line 1148
    invoke-virtual {v0}, Landroid/support/v7/view/menu/h;->dL()Z
    ...
    .line 1149
    iget-object v5, p0, Landroid/support/v7/view/menu/f;->Ps:Ljava/util/ArrayList;
    ...
    .line 1151
    :cond_3
    iget-object v5, p0, Landroid/support/v7/view/menu/f;->Pt:Ljava/util/ArrayList;
    ...
    .line 1161
    :cond_5
    iput-boolean v3, p0, Landroid/support/v7/view/menu/f;->Pu:Z
...
.method public final dF()Ljava/util/ArrayList;
    ...
    .prologue
    .line 1170
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->dE()V
...
.method public dG()Landroid/support/v7/view/menu/f;
    .locals 0
...
.method dx()Z
    ...
    .prologue
    .line 770
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Pn:Z
...
.method public dy()Z
    ...
    .prologue
    .line 799
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->Po:Z
...
.method public final dz()V
    ...
    .prologue
    .line 1042
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->PA:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->PA:Z

    .line 1044
    const/4 v0, 0x0

    iput-boolean v0, p0, Landroid/support/v7/view/menu/f;->PB:Z
...
.method public final e(Landroid/os/Bundle;)V
    ...
    .line 376
    invoke-static {v4}, Landroid/support/v4/view/l;->d(Landroid/view/MenuItem;)Z
    ...
    .line 387
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->dw()Ljava/lang/String;
...
.method public g(Landroid/support/v7/view/menu/h;)Z
    ...
    .line 1324
    :goto_2
    invoke-virtual {p0}, Landroid/support/v7/view/menu/f;->dA()V

    .line 1329
    if-eqz v0, :cond_0

    .line 1330
    iput-object p1, p0, Landroid/support/v7/view/menu/f;->PG:Landroid/support/v7/view/menu/h;
...
.method public h(Z)V
    ...
    .line 1026
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->Pr:Z

    .line 1027
    iput-boolean v1, p0, Landroid/support/v7/view/menu/f;->Pu:Z
...
.method public h(Landroid/support/v7/view/menu/h;)Z
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/f;->PG:Landroid/support/v7/view/menu/h;
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/f;->PG:Landroid/support/v7/view/menu/h;
...
.method public hasVisibleItems()Z
    ...
    .line 653
    iget-boolean v0, p0, Landroid/support/v7/view/menu/f;->PH:Z
...
.method public removeGroup(I)V
    ...
    .line 543
    invoke-direct {p0, v3, v1}, Landroid/support/v7/view/menu/f;->m(IZ)V
...
.method public removeItem(I)V
    ...
    invoke-direct {p0, v0, v1}, Landroid/support/v7/view/menu/f;->m(IZ)V
...
.method public setQwertyMode(Z)V
    ...
    .prologue
    .line 740
    iput-boolean p1, p0, Landroid/support/v7/view/menu/f;->Pn:Z
