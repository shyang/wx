...
# instance fields
.field public OF:Landroid/support/v7/view/menu/f$b;

.field private OG:Landroid/support/v7/widget/ListPopupWindow$b;

.field public OH:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 74
    sget v1, Landroid/support/v7/a/a$b;->HN:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getBoolean(I)Z

    move-result v1

    iput-boolean v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OI:Z

    .line 76
    sget-object v1, Landroid/support/v7/a/a$k;->aQ:[I
    ...
    iput v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OK:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OM:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OL:I
...
.method static synthetic a(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/ActionMenuItemView$b;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OH:Landroid/support/v7/view/menu/ActionMenuItemView$b;
...
.method static synthetic b(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/f$b;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OF:Landroid/support/v7/view/menu/f$b;
...
.method static synthetic c(Landroid/support/v7/view/menu/ActionMenuItemView;)Landroid/support/v7/view/menu/h;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dJ:Landroid/support/v7/view/menu/h;
...
.method private dp()V
    ...
    .line 173
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->ui:Ljava/lang/CharSequence;
    ...
    .line 174
    :goto_0
    iget-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jI:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_0

    iget-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dJ:Landroid/support/v7/view/menu/h;

    iget v3, v3, Landroid/support/v7/view/menu/h;->PN:I
    ...
    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OI:Z

    if-nez v3, :cond_0

    iget-boolean v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OJ:Z
...
.method public final a(Landroid/support/v7/view/menu/h;)V
    ...
    .line 112
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dJ:Landroid/support/v7/view/menu/h;
    ...
    iput-object v3, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jI:Landroid/graphics/drawable/Drawable;
    ...
    iget v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OM:I
    ...
    iget v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OM:I
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OM:I
    ...
    invoke-direct {p0}, Landroid/support/v7/view/menu/ActionMenuItemView;->dp()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->ui:Ljava/lang/CharSequence;
    ...
    .line 121
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OG:Landroid/support/v7/widget/ListPopupWindow$b;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OG:Landroid/support/v7/widget/ListPopupWindow$b;
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dJ:Landroid/support/v7/view/menu/h;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OI:Z
...
.method public onLongClick(Landroid/view/View;)Z
    ...
    .line 246
    invoke-static {p1}, Landroid/support/v4/view/y;->I(Landroid/view/View;)I
    ...
    .line 250
    :cond_1
    iget-object v8, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->dJ:Landroid/support/v7/view/menu/h;
...
.method protected onMeasure(II)V
    ...
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OL:I
    ...
    iget v4, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OK:I
    ...
    iget v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OK:I
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jI:Landroid/graphics/drawable/Drawable;
    ...
    .line 289
    iget-object v1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->jI:Landroid/graphics/drawable/Drawable;
    ...
    .line 276
    :cond_3
    iget v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OK:I
...
.method public setPadding(IIII)V
    ...
    .prologue
    .line 103
    iput p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->OL:I
