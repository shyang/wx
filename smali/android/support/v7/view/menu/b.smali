...
.field public OP:Landroid/content/Context;

.field protected OQ:Landroid/view/LayoutInflater;

.field private OR:I

.field private OS:I

.field public OT:Landroid/support/v7/view/menu/m;

.field public dN:Landroid/support/v7/view/menu/l$a;

.field public dO:Landroid/support/v7/view/menu/f;
...
.method public constructor <init>(Landroid/content/Context;II)V
    ...
    .line 58
    iput-object p1, p0, Landroid/support/v7/view/menu/b;->OP:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->OQ:Landroid/view/LayoutInflater;

    .line 60
    iput p2, p0, Landroid/support/v7/view/menu/b;->OR:I

    .line 61
    iput p3, p0, Landroid/support/v7/view/menu/b;->OS:I
...
.method public a(Landroid/support/v7/view/menu/h;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .line 180
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->OQ:Landroid/view/LayoutInflater;

    iget v1, p0, Landroid/support/v7/view/menu/b;->OS:I
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/f;)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->Cw:Landroid/view/LayoutInflater;

    .line 68
    iput-object p2, p0, Landroid/support/v7/view/menu/b;->dO:Landroid/support/v7/view/menu/f;
...
.method public a(Landroid/support/v7/view/menu/f;Z)V
    ...
    .prologue
    .line 206
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->dN:Landroid/support/v7/view/menu/l$a;
...
.method public c(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/m;
    ...
    .prologue
    .line 73
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->OT:Landroid/support/v7/view/menu/m;
    ...
    iget v1, p0, Landroid/support/v7/view/menu/b;->OR:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->OT:Landroid/support/v7/view/menu/m;

    .line 75
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->OT:Landroid/support/v7/view/menu/m;

    iget-object v1, p0, Landroid/support/v7/view/menu/b;->dO:Landroid/support/v7/view/menu/f;
...
.method public f(Z)V
    ...
    invoke-virtual {v1}, Landroid/support/v7/view/menu/f;->dE()V
    ...
    .line 104
    invoke-static {v9}, Landroid/support/v4/view/y;->aa(Landroid/view/View;)V
    ...
    :cond_3
    iget-object v1, p0, Landroid/support/v7/view/menu/b;->OT:Landroid/support/v7/view/menu/m;
...
.method public final getId()I
    ...
    .prologue
    .line 231
    iget v0, p0, Landroid/support/v7/view/menu/b;->dP:I
