...
# instance fields
.field private final Cw:Landroid/view/LayoutInflater;

.field public PK:Landroid/support/v7/view/menu/l$a;

.field public Pf:Z

.field private final Qf:Landroid/support/v7/view/menu/k$a;
...
.field public Qk:Landroid/support/v7/widget/ListPopupWindow;
...
.field public hr:Landroid/view/View;
...
.method static constructor <clinit>()V
    ...
    .prologue
    .line 51
    sget v0, Landroid/support/v7/a/a$h;->JM:I

    sput v0, Landroid/support/v7/view/menu/k;->Qe:I
...
.method private constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/f;Landroid/view/View;ZIB)V
    ...
    .line 77
    iput v2, p0, Landroid/support/v7/view/menu/k;->Qp:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->Cw:Landroid/view/LayoutInflater;

    .line 96
    iput-object p2, p0, Landroid/support/v7/view/menu/k;->dO:Landroid/support/v7/view/menu/f;

    .line 97
    new-instance v0, Landroid/support/v7/view/menu/k$a;

    iget-object v1, p0, Landroid/support/v7/view/menu/k;->dO:Landroid/support/v7/view/menu/f;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->Qf:Landroid/support/v7/view/menu/k$a;

    .line 98
    iput-boolean p4, p0, Landroid/support/v7/view/menu/k;->Qg:Z

    .line 99
    iput p5, p0, Landroid/support/v7/view/menu/k;->Qi:I

    .line 100
    iput v2, p0, Landroid/support/v7/view/menu/k;->Qj:I
    ...
    iput v0, p0, Landroid/support/v7/view/menu/k;->Qh:I

    .line 106
    iput-object p3, p0, Landroid/support/v7/view/menu/k;->hr:Landroid/view/View;
...
.method static synthetic a(Landroid/support/v7/view/menu/k;)Z
    ...
    .prologue
    .line 45
    iget-boolean v0, p0, Landroid/support/v7/view/menu/k;->Qg:Z
...
.method static synthetic b(Landroid/support/v7/view/menu/k;)Landroid/view/LayoutInflater;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Cw:Landroid/view/LayoutInflater;
...
.method static synthetic c(Landroid/support/v7/view/menu/k;)Landroid/support/v7/view/menu/f;
    ...
    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->dO:Landroid/support/v7/view/menu/f;
...
.method public final a(Landroid/support/v7/view/menu/f;Z)V
    ...
    .line 307
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->PK:Landroid/support/v7/view/menu/l$a;
...
.method public final a(Landroid/support/v7/view/menu/p;)Z
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/k;->hr:Landroid/view/View;
    ...
    iput-object v0, v3, Landroid/support/v7/view/menu/k;->PK:Landroid/support/v7/view/menu/l$a;
    ...
    .line 289
    :goto_1
    iput-boolean v0, v3, Landroid/support/v7/view/menu/k;->Pf:Z

    .line 291
    invoke-virtual {v3}, Landroid/support/v7/view/menu/k;->dP()Z
...
.method public final dP()Z
    ...
    iget v5, p0, Landroid/support/v7/view/menu/k;->Qi:I

    iget v6, p0, Landroid/support/v7/view/menu/k;->Qj:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/k;->Qk:Landroid/support/v7/widget/ListPopupWindow;

    .line 140
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Qk:Landroid/support/v7/widget/ListPopupWindow;
    ...
    iput-object p0, v0, Landroid/support/v7/widget/ListPopupWindow;->Xc:Landroid/widget/AdapterView$OnItemClickListener;

    .line 142
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Qk:Landroid/support/v7/widget/ListPopupWindow;

    iget-object v3, p0, Landroid/support/v7/view/menu/k;->Qf:Landroid/support/v7/view/menu/k$a;
    ...
    .line 145
    iget-object v3, p0, Landroid/support/v7/view/menu/k;->hr:Landroid/view/View;

    .line 146
    if-eqz v3, :cond_5

    .line 147
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Ql:Landroid/view/ViewTreeObserver;
    ...
    iput-object v5, p0, Landroid/support/v7/view/menu/k;->Ql:Landroid/view/ViewTreeObserver;
    ...
    iput-object v3, v0, Landroid/support/v7/widget/ListPopupWindow;->Xa:Landroid/view/View;

    .line 151
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Qk:Landroid/support/v7/widget/ListPopupWindow;

    iget v3, p0, Landroid/support/v7/view/menu/k;->Qp:I

    iput v3, v0, Landroid/support/v7/widget/ListPopupWindow;->Qp:I

    .line 156
    iget-boolean v0, p0, Landroid/support/v7/view/menu/k;->Qn:Z

    if-nez v0, :cond_3

    .line 157
    iget-object v7, p0, Landroid/support/v7/view/menu/k;->Qf:Landroid/support/v7/view/menu/k$a;
    ...
    :goto_2
    iget-object v5, p0, Landroid/support/v7/view/menu/k;->Qm:Landroid/view/ViewGroup;
    ...
    iput-object v5, p0, Landroid/support/v7/view/menu/k;->Qm:Landroid/view/ViewGroup;
    ...
    iget v11, p0, Landroid/support/v7/view/menu/k;->Qh:I

    if-lt v0, v11, :cond_6

    iget v2, p0, Landroid/support/v7/view/menu/k;->Qh:I

    :cond_2
    iput v2, p0, Landroid/support/v7/view/menu/k;->Qo:I

    .line 158
    iput-boolean v1, p0, Landroid/support/v7/view/menu/k;->Qn:Z

    .line 161
    :cond_3
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Qk:Landroid/support/v7/widget/ListPopupWindow;

    iget v2, p0, Landroid/support/v7/view/menu/k;->Qo:I
    ...
    invoke-virtual {v0}, Landroid/support/v7/widget/ListPopupWindow;->fj()V
    ...
    iget-object v0, v0, Landroid/support/v7/widget/ListPopupWindow;->WO:Landroid/support/v7/widget/ListPopupWindow$a;
...
.method public final f(Z)V
    ...
    iput-boolean v0, p0, Landroid/support/v7/view/menu/k;->Qn:Z

    .line 264
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->Qf:Landroid/support/v7/view/menu/k$a;
...
.method public onDismiss()V
    ...
    .line 175
    iput-object v1, p0, Landroid/support/v7/view/menu/k;->Qk:Landroid/support/v7/widget/ListPopupWindow;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/k;->hr:Landroid/view/View;

    invoke-virtual {v0}, Landroid/view/View;->getViewTreeObserver()Landroid/view/ViewTreeObserver;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/view/menu/k;->Ql:Landroid/view/ViewTreeObserver;
    ...
    .line 180
    iput-object v1, p0, Landroid/support/v7/view/menu/k;->Ql:Landroid/view/ViewTreeObserver;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-virtual {v0, p3}, Landroid/support/v7/view/menu/k$a;->aw(I)Landroid/support/v7/view/menu/h;
