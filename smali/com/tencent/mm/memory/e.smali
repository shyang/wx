...
# instance fields
.field protected clA:Ljava/util/NavigableMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private clB:Ljava/util/Vector;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Vector",
            "<",
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/tencent/mm/memory/e;->clA:Ljava/util/NavigableMap;
    ...
    iput-object v0, p0, Lcom/tencent/mm/memory/e;->clB:Ljava/util/Vector;

    .line 23
    const-wide/16 v0, 0x0

    iput-wide v0, p0, Lcom/tencent/mm/memory/e;->clC:J
...
.method private declared-synchronized J(J)V
    ...
    :try_start_0
    iget-wide v0, p0, Lcom/tencent/mm/memory/e;->clC:J
...
.method static synthetic a(Lcom/tencent/mm/memory/e;)V
    ...
    .line 14
    :goto_0
    iget-object v0, p0, Lcom/tencent/mm/memory/e;->clB:Ljava/util/Vector;
    ...
    invoke-virtual {v0}, Lcom/tencent/mm/memory/e$a;->wz()Ljava/lang/Comparable;
    ...
    invoke-virtual {v0}, Lcom/tencent/mm/memory/e$a;->wA()J

    move-result-wide v8

    invoke-virtual {v0}, Lcom/tencent/mm/memory/e$a;->wB()I
    ...
    :goto_1
    iget-wide v10, p0, Lcom/tencent/mm/memory/e;->clC:J

    invoke-virtual {p0}, Lcom/tencent/mm/memory/e;->wu()J
    ...
    invoke-virtual {p0, v10}, Lcom/tencent/mm/memory/e;->ar(Ljava/lang/Object;)J
    ...
    invoke-direct {p0, v10, v11}, Lcom/tencent/mm/memory/e;->J(J)V
    ...
    iget-object v1, p0, Lcom/tencent/mm/memory/e;->clA:Ljava/util/NavigableMap;
...
# virtual methods
.method protected final declared-synchronized K(J)V
    .locals 3
...
.method public declared-synchronized a(Ljava/lang/Comparable;)Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v0, p0, Lcom/tencent/mm/memory/e;->clA:Ljava/util/NavigableMap;
    ...
    .line 74
    iget-object v2, p0, Lcom/tencent/mm/memory/e;->clA:Ljava/util/NavigableMap;

    invoke-virtual {v0}, Lcom/tencent/mm/memory/d;->wx()Ljava/lang/Object;
    ...
    .line 75
    invoke-virtual {p0, v1}, Lcom/tencent/mm/memory/e;->ar(Ljava/lang/Object;)J

    move-result-wide v2

    invoke-virtual {p0, v2, v3}, Lcom/tencent/mm/memory/e;->K(J)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final a(Lcom/tencent/mm/memory/e$a;)V
    ...
    .line 29
    invoke-virtual {p0}, Lcom/tencent/mm/memory/e;->wy()V
...
.method public declared-synchronized aq(Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    invoke-virtual {p0, p1}, Lcom/tencent/mm/memory/e;->as(Ljava/lang/Object;)Ljava/lang/Comparable;

    move-result-object v1

    .line 113
    invoke-virtual {p0, p1}, Lcom/tencent/mm/memory/e;->ar(Ljava/lang/Object;)J

    move-result-wide v2

    .line 114
    invoke-virtual {p0}, Lcom/tencent/mm/memory/e;->wv()J
    ...
    :cond_1
    :try_start_1
    iget-wide v4, p0, Lcom/tencent/mm/memory/e;->clC:J
    ...
    iget-wide v6, p0, Lcom/tencent/mm/memory/e;->clC:J
    ...
    .line 127
    iget-object v4, p0, Lcom/tencent/mm/memory/e;->clA:Ljava/util/NavigableMap;

    invoke-interface {v4, v1, v0}, Ljava/util/NavigableMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 128
    invoke-direct {p0, v2, v3}, Lcom/tencent/mm/memory/e;->J(J)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method protected abstract ar(Ljava/lang/Object;)J
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)J"
        }
...
.method protected abstract as(Ljava/lang/Object;)Ljava/lang/Comparable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TT;)TS;"
        }
...
.method protected abstract wu()J
.end method

.method protected abstract wv()J
.end method
