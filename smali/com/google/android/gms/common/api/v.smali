...
.field public final amp:Landroid/util/SparseArray;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>()V
    ...
    iput v0, p0, Lcom/google/android/gms/common/api/v;->amm:I
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/api/v;->amo:Landroid/os/Handler;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/api/v;->amp:Landroid/util/SparseArray;
...
.method private a(ILcom/google/android/gms/common/ConnectionResult;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/v;->amp:Landroid/util/SparseArray;
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/v;->amp:Landroid/util/SparseArray;

    invoke-virtual {v1, p1}, Landroid/util/SparseArray;->remove(I)V

    invoke-virtual {p0}, Lcom/google/android/gms/common/api/v;->aJ()Landroid/support/v4/app/q;

    move-result-object v1

    invoke-virtual {v1, p1}, Landroid/support/v4/app/q;->destroyLoader(I)V

    iget-object v0, v0, Lcom/google/android/gms/common/api/v$b;->ams:Lcom/google/android/gms/common/api/c$c;
    ...
    :cond_0
    invoke-direct {p0}, Lcom/google/android/gms/common/api/v;->jE()V
...
.method public static c(Landroid/support/v4/app/FragmentActivity;)Lcom/google/android/gms/common/api/v;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/k;->k(Ljava/lang/String;)Landroid/support/v4/app/Fragment;
    ...
    iget-boolean v2, v0, Landroid/support/v4/app/Fragment;->oH:Z
    ...
    invoke-virtual {v2}, Landroid/support/v4/app/n;->commit()I
...
.method private jE()V
    ...
    iput-boolean v0, p0, Lcom/google/android/gms/common/api/v;->aml:Z

    const/4 v1, -0x1

    iput v1, p0, Lcom/google/android/gms/common/api/v;->amm:I

    const/4 v1, 0x0

    iput-object v1, p0, Lcom/google/android/gms/common/api/v;->amn:Lcom/google/android/gms/common/ConnectionResult;
    ...
    :goto_0
    iget-object v2, p0, Lcom/google/android/gms/common/api/v;->amp:Landroid/util/SparseArray;
    ...
    invoke-virtual {p0, v2}, Lcom/google/android/gms/common/api/v;->bI(I)Lcom/google/android/gms/common/api/v$a;

    move-result-object v3

    if-eqz v3, :cond_0

    iget-boolean v3, v3, Lcom/google/android/gms/common/api/v$a;->amw:Z

    if-eqz v3, :cond_0

    invoke-virtual {v1, v2}, Landroid/support/v4/app/q;->destroyLoader(I)V

    invoke-virtual {v1, v2, p0}, Landroid/support/v4/app/q;->a(ILandroid/support/v4/app/q$a;)Landroid/support/v4/content/c;
...
.method public final K(I)Landroid/support/v4/content/c;
    ...
    iget-object v0, v0, Lcom/google/android/gms/common/api/v$b;->amr:Lcom/google/android/gms/common/api/c;
...
.method public final synthetic a(Landroid/support/v4/content/c;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/ConnectionResult;->iY()Z

    move-result v0

    if-nez v0, :cond_0

    iget v0, p1, Landroid/support/v4/content/c;->dP:I

    iget-boolean v1, p0, Lcom/google/android/gms/common/api/v;->aml:Z

    if-nez v1, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, p0, Lcom/google/android/gms/common/api/v;->aml:Z

    iput v0, p0, Lcom/google/android/gms/common/api/v;->amm:I

    iput-object p2, p0, Lcom/google/android/gms/common/api/v;->amn:Lcom/google/android/gms/common/ConnectionResult;

    iget-object v1, p0, Lcom/google/android/gms/common/api/v;->amo:Landroid/os/Handler;
...
.method public final bI(I)Lcom/google/android/gms/common/api/v$a;
    .locals 3
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/app/q;->J(I)Landroid/support/v4/content/c;
...
.method public final onActivityResult(IILandroid/content/Intent;)V
    ...
    :cond_1
    iget v0, p0, Lcom/google/android/gms/common/api/v;->amm:I

    iget-object v1, p0, Lcom/google/android/gms/common/api/v;->amn:Lcom/google/android/gms/common/ConnectionResult;
...
.method public final onAttach(Landroid/app/Activity;)V
    ...
    iget-object v3, v3, Lcom/google/android/gms/common/api/v$a;->amr:Lcom/google/android/gms/common/api/c;
    ...
    invoke-virtual {v0, v2, p0}, Landroid/support/v4/app/q;->b(ILandroid/support/v4/app/q$a;)Landroid/support/v4/content/c;
    ...
    invoke-virtual {v0, v2, p0}, Landroid/support/v4/app/q;->a(ILandroid/support/v4/app/q$a;)Landroid/support/v4/content/c;
...
.method public final onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    iget v1, p0, Lcom/google/android/gms/common/api/v;->amm:I
...
.method public final onStart()V
    ...
    iget-boolean v0, p0, Lcom/google/android/gms/common/api/v;->aml:Z
